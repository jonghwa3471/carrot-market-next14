/*
  ...
  - Added the required column `stream_key` to the `LiveStream` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_LiveStream" ("created_at", "id", "title", "updated_at", "userId") SELECT "created_at", "id", "title", "updated_at", "userId" FROM "LiveStream";
